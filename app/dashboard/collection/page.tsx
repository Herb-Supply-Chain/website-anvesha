...
export default function CollectionPage() {
    ...
    const navItems = [
        ...
        { icon: Sprout, label: 'Collection', href: '/dashboard/collection', active: true },
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Manage herb collections and geo-tagged records</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                ...
                <main className="flex-1 p-8 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <Sprout className="w-12 h-12 text-teal-400" />
                            </div>
                        </div>
                        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
                            <div className="flex items-center justify-between">
                    ...
                    <div className="bg-gray-800 rounded-lg border border-gray-700">
                        <div className="px-6 py-4 border-b border-gray-700 flex items-center justify-between">
                            <h3 className="text-xl font-bold text-white">All Collections</h3>
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-b border-gray-700">
                                            ...
                                            <th className="text-left py-3 px-4 text-sm font-semibold text-gray-300">GPS Coordinates</th>
                                    ...
                                    <tbody>
                                        {collections.map((collection) => (
                                            <tr key={collection.id} className="border-b border-gray-700 hover:bg-gray-700/50 transition">
                                                ...
                                                <td className="py-4 px-4 text-sm text-gray-400">{collection.gpsCoords}</td>
